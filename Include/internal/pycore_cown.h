...
typedef uint64_t _PyCown_cuid_t;

//PyAPI_FUNC(PyObject*) _PyCown_New();
// PyAPI_FUNC(int) _PyCown_SetValue(_PyCownObject* self, PyObject* value);
PyAPI_FUNC(_PyCown_cuid_t) _PyCown_ConcurrentUnitId(void);
PyAPI_FUNC(int) _PyCown_RegionOpen(_PyCownObject *self, _PyBridgeObject* region, _PyCown_cuid_t cuid);
PyAPI_FUNC(int) _PyCown_RegionClose(_PyCownObject *self, _PyBridgeObject* region, _PyCown_cuid_t cuid);
