...
from immutable import is_deep_frozen
...
class TestPointer(BaseObjectTest):
    ...
    def test_contents_immutable(self):
        self.assertTrue(is_deep_frozen(self.a))
        self.assertTrue(is_deep_frozen(TestPointer.POINT))
...
class TestArray(BaseObjectTest):
    ...
    def test_point_immutable(self):
        self.assertTrue(is_deep_frozen(self.obj[0]))
        self.assertTrue(is_deep_frozen(TestArray.POINT))
