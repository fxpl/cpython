...
class BaseObjectTest(unittest.TestCase):
    def test_correct_traverse_visit_once(self):
        ...
        self.assertFalse(isfrozen(HasTraverseNoReachableHeap))
    ...
    def test_traverse_misses_type(self):
        ...
        # Make sure this is a fresh import
        self.assertFalse(isfrozen(IncorrectTraverseNoReachableHeap))
        ...
        self.assertTrue(isfrozen(IncorrectTraverseNoReachableHeap))
